...
public class MovieController {
	...
	@PostMapping("/create")
	public ResponseEntity<?> newMovie(@RequestBody Movie movie, @RequestParam MultipartFile file, BindingResult bindingResult)
			throws Exception{
	...
	@PutMapping("/update")
	public ResponseEntity<?> updateMovie(@RequestBody Movie movie, BindingResult bindingResult)
			throws Exception{
		try {
