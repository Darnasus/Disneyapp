package com.cappelletti.api.controller;
...
import com.cappelletti.api.entity.DisneyCharacter;
import com.cappelletti.api.entity.Movie;
import com.cappelletti.api.service.CharacterService;
import com.cappelletti.api.service.MovieService;
...
public class CharacterController {
	...
	@PostMapping("/create")
	public ResponseEntity<?> newCharacter(@RequestBody DisneyCharacter character, BindingResult bindingResult)
		{
		...
		return new ResponseEntity<>("Perosnaje creado correctamente", HttpStatus.CREATED);
	}

	@PutMapping("/update")
	public ResponseEntity<?> updateCharacter(@RequestBody DisneyCharacter character, BindingResult bindingResult)
			 {
		try {
			...
			return new ResponseEntity<>("Informacion actualizada", HttpStatus.CREATED);
		} catch (Exception e) {
			e.getMessage();
			return new ResponseEntity<>("La informacion no pudo actualizarse", HttpStatus.CONFLICT);
		}
